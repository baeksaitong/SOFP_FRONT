                        ...
                        onPressed: () {
                          showModalBottomSheet(
                            ...
                            builder: (BuildContext context) {
                                double height = MediaQuery.of(context).size.height*0.8; // 화면 높이의 50%로 설정
                                                ...
                                                children: [
                                                        ...
                                                        return GestureDetector(
                                                          onTap: () {
                                                            setStateModal(() {
                                                              ...
                                                              shapeText=shapeItems[index].text;
                                                            });
                                                          },
                                                          child: Container(
                                                            decoration: BoxDecoration(
                                                        ...
                                                        return GestureDetector(
                                                          onTap: () {
                                                            setStateModal(() {
                                                              ...
                                                              divideLineText=divideLineItems[index].text;
                                                            });
                                                          },
                                                          child: Container(
                                                            decoration: BoxDecoration(
                                                        ...
                                                        return GestureDetector(
                                                          onTap: () {
                                                            setStateModal(() {
                                                              ...
                                                              colorText=colorItems[index].text;
                                                            });
                                                          },
                                                          child: Column(
                                                            crossAxisAlignment: CrossAxisAlignment.center,
                                                  ...
                                                  Container(
                                                    ...
                                                    child: GridView.count(
                                                      ...
                                                      mainAxisSpacing: 10,
                                                      childAspectRatio: (76 / 68),
                                                      physics: NeverScrollableScrollPhysics(), // 스크롤 내부에서만 작동
                                                        ...
                                                        return GestureDetector(
                                                          onTap: () {
                                                            setStateModal(() {
                                                              ...
                                                              formulationText=formulationItems[index].text;
                                                            });
                                                          },
                                                          child: Container(
                                                            decoration: BoxDecoration(
